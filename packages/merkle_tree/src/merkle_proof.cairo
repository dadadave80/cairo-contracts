...
// OpenZeppelin Contracts for Cairo v4.0.1 (merkle_tree/src/merkle_proof.cairo)
...
pub fn process_multi_proof<impl Hasher: CommutativeHasher>(
    ...
    assert!(leaves_len + proof.len() == proof_flags_len + 1, "MerkleProof: invalid multi proof");
