...
// (presets/src/falcon_512_shake_direct_account.cairo)

/// # Falcon512ShakeDirectAccount Preset
///
/// OpenZeppelin's upgradeable Falcon-512 account using SHAKE-256 hash-to-point and on-chain
...
pub mod Falcon512ShakeDirectAccountUpgradeable {
    ...
    use openzeppelin_account::{Falcon512AccountComponent, Falcon512ShakeDirectVerifier};
